---
title: "英文 Email 修改教學：用 Claude 執香港 office 中英夾雜（唔變死板翻譯機）"
...
description: "英文 Email 修改教學：用 Claude 執香港 office 中英夾雜 email，保留你嘅 voice，唔會改過龍變死板翻譯機。教你個唔出罐頭句嘅 prompt。"
...
你知**呢封 email 個意思冇問題，但文法有錯、又中英夾雜睇落唔專業**。 但你又唔想丟畀 ChatGPT，因為佢通常會：
...
<PromptBlock label="完整 prompt — 唔會搞死你個 voice">
...
以下係客戶 / 同事 send 嚟嘅 email（佢哋投訴 / 要求嘅嘢我答應唔到）。

請幫我寫一個回覆：
1. 先表示理解對方嘅疑慮（兩句，唔好假惺惺）
2. 解釋我哋嘅立場（簡單直接啲，唔好賣慘亦唔好逞強）
3. 提議其他方案（如果有）／ 解釋下一步
4. 語氣：尊重但企得硬，唔卑唔亢
...
<PromptBlock label="變化 3 — 精簡 email">
以下呢封 email 太長，對方睇唔晒。
請幫我精簡到 100 字以內，保留：
