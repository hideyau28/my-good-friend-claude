...
- Inline AI 自動補全（類似 Copilot 但模型唔同）
...
第 1 日安裝 + 設定：1 個鐘成本第 2-7 日：每日 30 分鐘「我仲摸索緊」嘅唔順第 8 日後：每日流程順暢
...
- ⚠️ **監察 API 開支**。Claude Code 用量透過 Anthropic console 追蹤。先設 $50 月度預算。1 個禮拜後你會摸清真實成本。
