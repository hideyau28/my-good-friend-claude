...
4. 一唔小心改埋 `apps/web` 嘅 login flow，你覆檢嗰陣先發現
...
Claude 學識篩選之後，唔會再喺 root 撞 install。
...
Monorepo 嘅核心唔係「將代碼放埋一齊」— 係**邊界**。Package boundary 喺人類眼中係 folder structure，喺 Claude 眼中**預設係透明嘅**，因為佢嘅預設 tool 係 flat grep。
