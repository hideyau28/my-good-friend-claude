...
- **強項**：抽走重覆代碼、寫單元測試、補文件字串；最輕量；Microsoft 整合埋 GitHub Issues / Pull Request
...
- Cursor 嘅行內編輯配合游標位置（你 highlight 一段、撳 `cmd+K`、同佢講想點改）— 對於逐步維護最快
...
1. 邊方面 [工具 B] 比 [工具 A] 強
2. 邊方面 [工具 B] 比 [工具 A] 弱
3. 我嘅工作流程係 [描述日常編程點做]，喺呢個流程入面，轉用新工具會係利多於弊定弊多於利
...
我哋想統一一個 AI coding 工具（為咗：分享 prompt、代碼風格一致、團體授權）。
