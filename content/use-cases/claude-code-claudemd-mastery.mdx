...
你用咗 Claude Code 兩個禮拜，跑得幾順。但有個規律一直 frustrating：
...
Claude Code 喺 sub-folder 跑會自動讀兩層。記住：**子層唔好 repeat 父層** —— 只寫 delta。

### 變化 2：Team CLAUDE.md — 人類 + AI 都讀你 team 可能淨係一兩個人用 Claude Code，其他人用 VS Code。寫一份兩邊都用得到嘅版本：
