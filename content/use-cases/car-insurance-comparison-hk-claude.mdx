...
description: "HK 車保續保嗰陣，broker send 3 個 quote 同 30 頁條款。用 Claude 一次過讀晒：no-claim discount 計法、飛石玻璃自付額、商場車位碰撞細項，揾出真正性價比。"
...
表格列出三間：第三者保額、自己車身保額、醫療保額、玻璃自付額、商場車位碰撞 excess、其他常見 excess、NCB% 同條款、隨車物品上限。
...
<PromptBlock label="第 4 步 — 續保定轉會 decision matrix">
...
請額外揾出：
1. 三間 quote 喺「商用」/「hire and reward」條款點寫——私家車牌做 Uber 可能直接令保單失效
2. 第三者保額對乘客 / 貨物嘅覆蓋
3. 司機僱員責任（Employees' Compensation）有冇包埋
4. 每日 / 每年里數上限對商用嘅影響
5. 邊間有專門嘅「Private Hire」/「Goods Carrying」附加 plan
6. 出事如果保險公司發現實際用途同申報唔同，會點處理
</PromptBlock>
