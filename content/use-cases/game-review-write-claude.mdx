...
呢類具體時刻**就係你評論嘅原料**。但慣性寫作模式會將你推返去行貨字眼：「good combat」「great atmosphere」「definitely worth it」。

呢個思維嘅轉變：**寫評論嘅工藝，就係 *拒絕* 慣性字眼、具體描述你實際經歷嗰啲時刻嘅技巧**。

Claude 喺呢度嘅角色：4 軸框架逼你具體寫晒，而唔係跌返慣性模式嘅行貨寫法。Claude 幫你整理嘅嘢，係**你已經有但講唔出嘅具體意見**。
