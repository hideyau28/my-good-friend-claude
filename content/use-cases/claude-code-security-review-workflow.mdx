...
呢類風險共通規律：**唔係冇能力 review，係冇時間 + 冇紀律每次覆檢**。手動逐個 PR 逐個 file 對 OWASP top 10 + 掃 secret + 試 RBAC bypass —— 1 個 PR 起碼 1 個鐘，你冇可能每次做。
...
Test fail = 你個 RBAC 有窿。Test pass = 第一層 sanity 睇吓過。
